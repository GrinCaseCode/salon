...
if ( $(this).scrollTop() > 0 && $menu.hasClass("default") ){
	...
	$(".sandwich").click(function() {
		...
		$(".header-bottom").addClass("header-bottom_mobile");
	...
	$(".header-bottom .location-main__value").click(function() {
		$(this).toggleClass("active");
		$(".header-bottom .location-main__dropdown").slideToggle(200);
	});
...

	{
		if ($(window).width() < 992) { 
			...
			$('.item-location').click(function() {
				$('html').animate({ 
					scrollTop: $("#map-contacts").offset().top - 75
				}, 1000 
				);
			}); 
		}
